...
const tripSchema = z.object({
  ...
  totalSeats: z.number({ coercion: true }).min(1),
  availableSeats: z.number({ coercion: true }).min(0),
  totalCargoCapacity: z.number({ coercion: true }).min(0),
  availableCargoCapacity: z.number({ coercion: true }).min(0),
  pricingEconomy: z.number({ coercion: true }).min(0),
  pricingBusiness: z.number({ coercion: true }).min(0),
  pricingFirstClass: z.number({ coercion: true }).min(0),
  amenities: z.string(),
});
